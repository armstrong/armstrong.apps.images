...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('images_imageset', (
            ('content_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['content.Content'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('images', ['ImageSet'])

        # Adding model 'ImageSetElement'
        db.create_table('images_imagesetelement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Image'])),
            ('imageset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.ImageSet'])),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('images', ['ImageSetElement'])


    def backwards(self, orm):
        
        # Deleting model 'ImageSet'
        db.delete_table('images_imageset')

        # Deleting model 'ImageSetElement'
        db.delete_table('images_imagesetelement')
    ...
    models = {
        ...
        'images.imageset': {
            'Meta': {'object_name': 'ImageSet', '_ormbases': ['content.Content']},
            'content_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['content.Content']", 'unique': 'True', 'primary_key': 'True'})
        },
        'images.imagesetelement': {
            'Meta': {'ordering': "('order',)", 'object_name': 'ImageSetElement'},
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['images.Image']"}),
            'imageset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['images.ImageSet']"}),
